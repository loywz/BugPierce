...
<title>Home</title>
    ...
    <link rel="stylesheet" type="text/css" href="css/estiloRegisterEmpresa.css">
     ...
     <div class="screen-body"> 
        ...
        <div class="screen-body-item">
          <div class="app-form">
            ...
            <form action="acao/registrarEmpresa.php" method="POST">
            ...
            <?php endif; unset($_SESSION['status_cadastro']) ?>
                ...
                <input class="app-form-control" placeholder="NOME EMPRESA" name="Rempresa">
                </div>
                <div class="app-form-group"> 
